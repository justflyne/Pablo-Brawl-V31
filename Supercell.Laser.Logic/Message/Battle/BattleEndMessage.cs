namespace Supercell.Laser.Logic.Message.Battle
{
    ...
    public class BattleEndMessage : GameMessage
    {
        ...
        // events
        public int DoubleTokenEvent;
        public int CoinEventReward;
        // end events
        ...
        {        
            ...
            Stream.WriteVInt(DoubleTokenEvent);
            Stream.WriteVInt(TokenDoublersLeft);
            Stream.WriteVInt(0); // big game/robo rumble time
            ...
            Stream.WriteVInt(0);
            Stream.WriteVInt(0);
            Stream.WriteVInt(CoinEventReward); // i think so
