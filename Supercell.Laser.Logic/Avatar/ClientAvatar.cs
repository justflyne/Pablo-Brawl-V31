namespace Supercell.Laser.Logic.Avatar
{
    ...
    public class ClientAvatar
    {
        ...
        [JsonProperty] public bool IsCreator;
        ...
        [JsonProperty] public bool MuteRoomChat;
        ...
        public void GiveTrophies(int trophies, int brawlerid)
        {
            Hero brawler = Heroes.FirstOrDefault(h => h.CharacterId == 16000000 + brawlerid);

            if (brawler != null)
            {
                brawler.Trophies += trophies;
                brawler.HighestTrophies += trophies;
            }
        }
        
        public void TakeTrophies(int trophies, int brawlerid)
        {
            Hero brawler = Heroes.FirstOrDefault(h => h.CharacterId == 16000000 + brawlerid);
