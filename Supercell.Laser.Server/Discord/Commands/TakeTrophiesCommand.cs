namespace Supercell.Laser.Server.Discord.Commands
{
    ...
    public class TakeTrophies : CommandModule<CommandContext>
    {
        [Command("taketrophies")]
        public static string taketrophies(
        ...
        )
        {
            ...
            {
                return "Usage: !taketrophies [TAG] [amount] [brawlerid]";
            }
            ...
            account.Avatar.TakeTrophies(trophyCount, brawlerid);
            ...
            return $"Удалено {trophyCount} трофеев у бойца {brawlerid} для аккаунта с айди {parts[0]}.";
        }
    }
}