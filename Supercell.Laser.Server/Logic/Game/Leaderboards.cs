namespace Supercell.Laser.Server.Logic.Game
{
    ...
    public static class Leaderboards
    {
        ...
        private static List<Account> PowerPlay;
        ...
        public static Account[] GetPowerPlayRankingList()
        {
            return Accounts.ToArray();
        }
        ...
        private static void Update()
        {
            while (true)
            {
                ...
                PowerPlay = Database.Accounts.GetPowerPlayRankingList();
            }
        }
    }
}
