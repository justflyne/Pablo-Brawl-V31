    ...
    public static class Accounts
    {
        ...
        public static Account Create()
        {
            ...
            n.Add(
                ...
                {
                    Id = 83,
                    PrimaryMessageEntry = "Добро пожаловать в <cff2a00>P<cff5400>a<cff7f00>b<cffa900>l<cffd400>o<cfefe00> <cffff00>B<cd4ff00>r<caaff00>a<c7fff00>w<c55ff00>l</c>!",
                    SecondaryMessageEntry = "Также рекомендуем зайти в наш тг канал и чат нажав кнопку ниже! (t.me/pablo_servers)",
                    ButtonMessageEntry = "ПЕРЕЙТИ",
                    FileLocation = "abyss_banner.png",
                    FileSha = "d75e9da0e8b93b581974435730c25581a3cad9b0",
                    ExtLint = "brawlstars://extlink?page=https%3A%2F%2Ft.me%2Fpablo_servers",
                }
            );
        ...
        public static List<Account> GetPowerPlayRankingList()
        {
            var list = new List<Account>();
            ...
            try
            {
                ...
                using (var connection = new MySqlConnection(ConnectionString))
                {
                    ...
                    using (
                        var cmd = new MySqlCommand(
                            $"SELECT * FROM accounts ORDER BY CAST(Data->>'$.Home.PowerPlayScore' AS UNSIGNED) DESC LIMIT 200",
                            connection
                        )
                    )
                    {
                ...
                list = list.OrderByDescending(a => a.Home.PowerPlayScore).ToList();
